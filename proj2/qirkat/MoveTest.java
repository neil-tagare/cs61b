...
public class MoveTest {
    ...
    public void testMovetwo() {
        Move jump =  move(move('a', '3', 'a', '3'),
                move('a', '5', 'c', '3'));
        assertEquals("a3-a5-c3", jump.toString());

        Move jump2 = move(parseMove("a3-a5-c3-e1"), move('e', '1', 'c', '3'));
        assertEquals("a3-a5-c3-e1-c3", jump2.toString());
    }
}
